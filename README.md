...
Die Projektdateien für das Kapitel 18 vom Buch **Zend Framework 2 - Das
Praxisbuch** (*ISBN 978-3-8362-2610-3*) von Ralf Eggert 
aus dem Galileo-Computing Verlag installieren Sie wie folgt:

* Sie können die Projektdateien von https://github.com/ZF2Buch2/kapitel18 als  
...
```
    ...
    $ git clone https://github.com/ZF2Buch2/kapitel18.git
    $ cd kapitel18/
```
